...
public:
  JTimer(){ Reset(); }
  void Reset(){ Stopped=false; CounterIni.tv_sec=0; CounterIni.tv_usec=0; CounterEnd.tv_sec=0; CounterEnd.tv_usec=0; }
  void Start(){ Stopped=false; gettimeofday(&CounterIni,NULL); }
  void Stop(){ gettimeofday(&CounterEnd,NULL); Stopped=true; }
  //-Returns time in miliseconds.
